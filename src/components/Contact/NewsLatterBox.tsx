...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-5 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Subscribe to IQnaut for future updates and to get special offers.
      </p>
      <div>
        <div className="mt-10 flex flex-col items-center">
          <div className="mb-12 flex items-center space-x-40">
            <FaFacebookF size={32} className="cursor-pointer hover:scale-110" />
            <button className="rounded-full bg-white px-6 py-3 font-semibold text-black transition hover:bg-gray-100 lg:w-28">
              Follow
            </button>
          </div>
          <div className="mb-12 flex items-center space-x-40">
            <FaXTwitter size={32} className="cursor-pointer hover:scale-110" />
            <button className="rounded-full bg-white px-6 py-3 font-semibold text-black transition hover:bg-gray-100 lg:w-28">
              Follow
            </button>
          </div>
          <div className="mb-12 ml-4 flex items-center space-x-36 md:ml-0 md:space-x-40 lg:space-x-40">
            <IoLogoYoutube
              size={32}
              className="cursor-pointer hover:scale-110"
            />
            <button className="flex items-center justify-center rounded-full bg-white px-6 py-3 font-semibold text-black transition hover:bg-gray-100 lg:w-28">
              Subscribe
            </button>
          </div>

          <div className="mb-12 ml-3 flex items-center space-x-40 md:ml-0 lg:ml-0">
            <FaLinkedin size={32} className="cursor-pointer hover:scale-110" />
            <button className="rounded-full bg-white px-6 py-3 font-semibold text-black transition hover:bg-gray-100 lg:w-28">
              Connect
            </button>
          </div>
        ...
        <p className="mt-5 text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          No spam guaranteed.
        </p>
      </div>
