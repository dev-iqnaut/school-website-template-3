...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Streamline school operations with tools for managing students, teachers, timetables, and attendance—all from a single platform.",
  },
  {
    id: 1,
    icon: (
      ...
      >
        <rect
          ...
          stroke-width="5"
        />
        <circle cx="240" cy="370" r="20" fill="#4A6CF7" />
        <circle cx="140" cy="70" r="10" fill="#4A6CF7" />
        <rect x="200" y="60" width="80" height="20" rx="5" fill="#4A6CF7" />
      </svg>
    ),
    title: "Parent Engagement App",
    paragraph:
      "Keep parents informed about their child’s attendance, assignments, test schedules, and school notifications in real time.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Behavioral & Performance Analytics",
    paragraph:
      "Monitor student behavior, attendance trends, and academic progress with actionable insights for better decision-making.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Generate professional, detailed report cards instantly, saving time for teachers and administrators.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Send instant notifications to parents, teachers, or the entire school for important updates and announcements.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Attendance Management & Analytics",
    paragraph:
      "Track and analyze student attendance with ease, allowing for proactive interventions when needed.",
  },
  {
    id: 1,
    icon: (
      ...
      >
        ...
        <rect x="70" y="30" width="100" height="140" rx="8" fill="#4A6CF7" />
        ...
        <rect x="100" y="45" width="50" height="4" rx="2" fill="white" />
        <rect x="100" y="70" width="50" height="4" rx="2" fill="white" />
        <rect x="100" y="95" width="50" height="4" rx="2" fill="white" />

        <path d="M50 150l5-40 10 10-5 40z" fill="#4A6CF7" />

        <path d="M55 110l10 10-5 5-5-5z" fill="#4A6CF7" />
      </svg>
    ),
    title: "Assignment & Test Management",
    paragraph:
      "Organize, track, and evaluate assignments and tests with ease, providing teachers and parents with performance updates.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Ensure seamless communication with support for multiple languages, including English, Hindi, Tamil, Telugu, Kannada, Malayalam, Bengali, and Marathi.",
  },
  {
    id: 1,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="500" height="400" viewBox="0 0 500 400">
  <rect x="180" y="70" width="260" height="160" rx="10" fill="#4A6CF7"/>
  <rect x="200" y="100" width="120" height="10" rx="5" fill="white"/>
  <rect x="200" y="130" width="180" height="10" rx="5" fill="white"/>
  <rect x="200" y="160" width="160" height="10" rx="5" fill="white"/>
  <circle cx="110" cy="170" r="35" fill="#4A6CF7"/> 
  <path d="M85 200 C55 220, 55 260, 110 260 L130 260 C155 260, 155 220, 130 200 Z" fill="#4A6CF7"/> 
  <rect x="80" y="260" width="25" height="55" fill="#4A6CF7"/> 
  <rect x="115" y="260" width="25" height="55" fill="#4A6CF7"/> 
  <path d="M130 200 L200 160 L210 170 L140 210 Z" fill="#4A6CF7"/>
  <rect x="200" y="160" width="5" height="100" fill="#4A6CF7"/>
</svg>

    ),
    title: "Teacher Tools & Apps",
    paragraph:
      "Enable teachers to manage schedules, assignments, tests, attendance, and parent communication on the go.",
  },
];
